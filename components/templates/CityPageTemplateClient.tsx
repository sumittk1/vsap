...
import { CityConfig } from "./CityPageTemplate";

export default function CityPageTemplateClient({ config }: { config: CityConfig }) {
  const [activeFaq, setActiveFaq] = useState<number | null>(null);

  const faqItems = [
    {
      question: "Do you work locally?",
      answer: `Yes. We work extensively with businesses in ${config.name} and the GTA. We understand the local market, the competition, and what actually works here.`
    },
    {
      question: "Can we meet in person?",
      answer: "Absolutely. We offer in-person strategy calls and consultations at our office. We also work virtually if that suits your schedule better."
    },
    {
    ...
    },
    {
      ...
      answer: `We've worked with dentists, contractors, lawyers, real estate agents, clinics, and hospitality businesses in ${config.name}. If you serve local customers, we can help.`
    }
  ];
  ...
  const cityTestimonials = [
    ...
    {
      quote: '"Finally, someone who knows our area and actually cares about our growth."',
      name: 'Michele Torres',
    ...
    <>
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <Reveal variant={slideInLeft}>
              <Eyebrow light>{config.name}</Eyebrow>
            ...
            <Reveal variant={slideInRight} delay={0.1}>
              <p className="text-body-lg text-white/85 mb-8 leading-relaxed">
                We help local businesses in {config.name} get found on Google,
                Maps, and paid ads. Our team knows how to drive real growth for
                your business.
              </p>
      ...
      <Section bg="lavender" className="py-20 md:py-24">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
            ...
            <div className="flex flex-col items-start">
              <Reveal>
                ...
                <h2 className="text-h2 text-foreground mb-4 leading-tight">Why {config.name} businesses choose VASP Digital</h2>
                <p className="text-body text-muted leading-relaxed mb-8 max-w-xl">
                  We're not a distant agency. We understand the {config.name} market inside out. Your success is our success.
                </p>
          ...
          {/* What we do for City (Services Section) */}
          <div className="border-t border-border/50 pt-20">
            <div className="text-center mb-16">
              <Reveal>
                ...
                <h2 className="text-h2 text-foreground mb-3">What we do for {config.name}</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="lg:col-span-5 bg-white border border-border/70 rounded-[24px] overflow-hidden flex flex-col justify-between shadow-sm">
                ...
                <div className="p-8 flex flex-col items-start flex-grow justify-center">
                  ...
                  <p className="text-sm text-muted leading-relaxed mb-6">Rank higher on Google and own your {config.name} market</p>
              ...
              <div className="lg:col-span-3 flex flex-col gap-8">
                ...
                <div className="bg-white border border-border/70 rounded-[24px] p-6 flex flex-col justify-center items-start shadow-sm flex-1">
                  ...
                  <p className="text-xs text-muted leading-relaxed">Google Ads and paid search drive leads and sales in {config.name}</p>
                </div>
                {/* More card */}
                <div className="bg-white border border-border/70 rounded-[24px] p-6 flex flex-col justify-center items-start shadow-sm flex-1">
                  <div className="w-10 h-10 rounded-xl bg-brand-lavender border border-border flex items-center justify-center text-brand-purple mb-4">
              ...
              <div className="lg:col-span-4 flex flex-col gap-8 justify-between">
                ...
                <div className="bg-white border border-border/70 rounded-[24px] overflow-hidden flex shadow-sm p-4 gap-4 items-center flex-1">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-muted leading-relaxed mb-2">Get found when customers search nearby in {config.name}</p>
                    <Link 
      ...
      {/* Industries winning in City Section */}
        ...
        <Container>
          <div className="text-center mb-16">
            <Reveal>
              ...
              <h2 className="text-h2 text-white mb-3">Industries winning in {config.name}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#fafafa]/5 border border-white/10 rounded-[24px] overflow-hidden flex shadow-sm items-stretch">
              <div className="p-6 flex flex-col justify-between flex-1">
                <div>
                  ...
                  <p className="text-xs text-white/70 leading-relaxed mb-6">3x more new patient appointments monthly in {config.name}</p>
                </div>
                <Link 
            ...
            <div className="bg-[#fafafa]/5 border border-white/10 rounded-[24px] overflow-hidden flex flex-col justify-between shadow-sm">
              <div className="p-6">
                ...
                <p className="text-xs text-white/70 leading-relaxed mb-4">Ranked number one in Google Maps locally in {config.name}</p>
                <Link 
            ...
            <div className="bg-[#fafafa]/5 border border-white/10 rounded-[24px] overflow-hidden flex flex-col justify-between shadow-sm">
              <div className="p-6">
                ...
                <p className="text-xs text-white/70 leading-relaxed mb-4">200% percent increase in qualified leads in {config.name}</p>
                <Link 
      ...
      {/* How City businesses grew with us (Lavender background) */}
      <Section bg="lavender" className="py-20 md:py-24 border-t border-border">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-24">
            ...
            <div className="flex flex-col items-start">
              <Reveal>
                ...
                <h2 className="text-h2 text-foreground mb-6 leading-tight">How {config.name} businesses grew with us</h2>
                <p className="text-sm text-muted leading-relaxed mb-8 max-w-xl">
                  See what's possible when strategy meets execution. These are real results from businesses we've worked with.
                </p>
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted">Home services business claimed the top spot in Google Maps locally.</p>
                  </div>
                  <div>
              ...
              <div className="flex flex-col items-start">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-8 mb-10 text-left">
                  ...
                  <div>
                    ...
                    <h4 className="font-bold text-sm text-foreground mb-1 leading-snug">We know {config.name}</h4>
                    <p className="text-xs text-muted leading-relaxed">We understand your market, your competition, and what actually works.</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted leading-relaxed">Strategy calls at our office or virtually, whichever suits you best.</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted leading-relaxed">We know your competition, your customers, and what actually works in your area.</p>
                  </div>
          ...
          {/* How we grow City businesses (Process section) */}
          <div className="border-t border-border/50 pt-20">
            <div className="text-center mb-16">
              <Reveal>
                <span className="text-xs font-bold uppercase tracking-wider text-brand-purple block mb-2 font-display">Process</span>
                <h2 className="text-h2 text-foreground mb-3">How we grow {config.name} businesses</h2>
                <p className="text-body text-muted">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
              ...
              <div className="flex flex-col bg-white border border-border/70 rounded-[20px] overflow-hidden shadow-sm h-full group">
                <div className="p-6">
                  ...
                  <h3 className="font-semibold text-lg text-foreground mb-2 leading-snug">Understand your {config.name} market</h3>
                  <p className="text-xs text-muted leading-relaxed mb-4">We audit your current presence and analyze what your competitors in {config.name} are doing.</p>
                  <Link 
                    href="/contact"
              ...
              <div className="flex flex-col bg-white border border-border/70 rounded-[20px] overflow-hidden shadow-sm h-full group">
                <div className="p-6">
                  ...
                  <p className="text-xs text-muted leading-relaxed mb-4">Strategy tailored to {config.name}'s market, your industry, and your goals.</p>
                  <Link 
                    href="/contact"
                    className="font-sans font-bold text-xs uppercase tracking-wider text-foreground hover:text-brand-purple inline-flex items-center gap-1.5 group/link"
                  >
      ...
      <section className="bg-brand-coral py-20 md:py-24 text-white relative overflow-hidden">
        <Container className="max-w-6xl text-center">
          ...
          <Reveal>
            ...
            <p className="text-body-lg text-white/80 mb-12">From {config.name} businesses</p>
          </Reveal>
        ...
        <Container className="max-w-4xl">
          <div className="text-center mb-16">
            <Reveal>
              ...
              <p className="text-body text-muted">
                Common questions from {config.name} business owners about our services and process.
              </p>
            </Reveal>
          </div>
      ...
      {/* Ready to grow your City business? CTA Section */}
      <section className="bg-brand-coral py-20 md:py-24 text-white relative overflow-hidden">
        <Container className="max-w-4xl text-center">
          <Reveal>
            <h2 className="text-h2 text-white mb-3 leading-tight">Ready to grow your {config.name} business?</h2>
