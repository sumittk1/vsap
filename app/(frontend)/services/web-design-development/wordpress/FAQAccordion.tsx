...
export default function FAQAccordion({ items }: { items: FAQItem[] }) {
  ...
  return (
    <Section bg="lavender" className="py-16 md:py-24">
      <Container>
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-24 space-y-8">
            ...
            <Reveal delay={0.1}>
              <div className="space-y-4">
                <h3 className="text-h3 font-semibold text-foreground">Still have questions?</h3>
                <p className="text-body text-muted">
                  Get in touch and we'll answer them.
                </p>
                <Button href="/contact" variant="secondary" className="!shadow-none hover:!bg-gray-100 bg-white">
                  Contact
                </Button>
              </div>
            </Reveal>
